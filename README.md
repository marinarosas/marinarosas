...
Sou desenvolvedora fullstack, com mais de 1 ano de experiência em desenvolvimento, sou formada no curso de Web Full Stack, tendo experiência em projetos práticos individuais e em grupo, utilizando tecnologias como HTML, CSS, JavaScript, React, Node Js, TypeScript, POO, SQL, Jest e outras. Dentro do bootcamp da Labenu auxílio meus colegas, liderando encontros semanais, nos quais procuro esclarecer dúvidas dos projetos, atividades e exercícios ministrados no curso. <br>
